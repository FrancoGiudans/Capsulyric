 ...
 *
 * Upstream source: Scaffold (miuix-ui/src/commonMain/kotlin/top/yukonga/miuix/kmp/basic/Scaffold.kt) and miuix-blur layerBackdrop / rememberLayerBackdrop
 *
 * Modifications by FrancoGiudans for Capsulyric (IslandLyrics):
 *   - Wrapper adding a layer-backdrop blur behind the miuix Scaffold.
 */
