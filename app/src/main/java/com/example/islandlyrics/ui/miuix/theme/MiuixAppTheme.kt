 ...
 *
 * Upstream source: miuix theme APIs: MiuixTheme, ThemeController, ColorSchemeMode, ThemePaletteStyle, darkColorScheme, lightColorScheme
 *
 * Modifications by FrancoGiudans for Capsulyric (IslandLyrics):
 *   - App-level Miuix theme wrapper built on miuix theme APIs.
 */
