...
fun ParserRule.toEditorState(): ParserRuleEditorState = ParserRuleEditorState(
    ...
    onlineLyricDisabledProviders = OnlineLyricProvider.normalizeDisabledIds(onlineLyricDisabledProviders)
        ...
        .toSet(),
    appleMusicStorefrontOverride = appleMusicStorefrontOverride,
    appleMusicLanguageOverride = appleMusicLanguageOverride,
...
fun ParserRuleEditorState.withSourceSettingsFrom(source: ParserRuleEditorState): ParserRuleEditorState = copy(
    ...
    appleMusicStorefrontOverride = source.appleMusicStorefrontOverride,
    appleMusicLanguageOverride = source.appleMusicLanguageOverride,
