...
import com.example.islandlyrics.feature.applemusic.material.AppleMusicSettingsScreen
import com.example.islandlyrics.feature.applemusic.miuix.MiuixAppleMusicSettingsScreen
...
class AppleMusicSettingsActivity : BaseActivity() {
            ...
            if (isMiuixEnabled(this)) {
                MiuixAppTheme {
                    PredictiveBackActivity {
                        MiuixAppleMusicSettingsScreen(onBack = { finish() })
                    }
                }
            } else {
                AppTheme {
                    PredictiveBackActivity {
                        AppleMusicSettingsScreen(onBack = { finish() })
                    }
                }
            }
        }
