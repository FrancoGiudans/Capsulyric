...
class LocalLyricDirectoryManager private constructor(private val context: Context) {
    ...
    private val prefs = AppPreferences.of(context)
    ...
    companion object {
        ...
        private const val KEY_DIRECTORIES = AppPreferences.Keys.LOCAL_LYRIC_DIRECTORIES_JSON
        private const val KEY_CUSTOM_MATCHES = AppPreferences.Keys.LOCAL_LYRIC_CUSTOM_MATCHES_JSON
        private const val KEY_EXPORT_DIRECTORY = AppPreferences.Keys.LOCAL_LYRIC_EXPORT_DIRECTORY_URI
        private const val KEY_EXPORT_MATCH_SYNC_ENABLED = AppPreferences.Keys.LOCAL_LYRIC_EXPORT_MATCH_SYNC_ENABLED
